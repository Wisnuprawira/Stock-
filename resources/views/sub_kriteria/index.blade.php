    ...
    <div class="row small-spacing">
        <div class="col-xs-12">
            ...
            <div class="box-content">
                ...
                <!-- /.box-title -->
                <a href="{{ route('sub.kriteria.createPages') }}" class="btn btn-primary mb-2" style="margin-bottom: 10px;">Tambah
                    Sub Kriteria</a>
                ...
                <table id="example" class="table table-striped table-bordered display" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: middle;">{{$value->kriteria->kode}} - {{$value->kriteria->nama}}</td>
                            <td class="align-middle" style="vertical-align: middle;">{{$value->kode}}</td>
                            <td style="vertical-align: middle;">{{$value->nama}}</td>
                            
                            <td class="text-center">
                                <a href="{{route('sub.kriteria.editPages',$value->id)}}" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                                <a href="{{route('sub.kriteria.delete',$value->id)}}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
