    ...
    <div class="row small-spacing">
        <div class="col-xs-12">
            ...
            <div class="box-content">
                ...
                <!-- /.box-title -->
                <a href="{{ route('user.createPages') }}" class="btn btn-primary mb-2" style="margin-bottom: 10px;">Tambah User</a>
                ...
                <table id="example" class="table table-striped table-bordered display" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-middle" style="vertical-align: middle;">{{$value->name}}</td>
                            <td style="vertical-align: middle;">{{$value->email}}</td>
                            <td style="vertical-align: middle;">{{$value->jabatan}}</td>
                            <td class="text-center">
                                <a href="{{route('user.editPages',$value->id)}}" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
